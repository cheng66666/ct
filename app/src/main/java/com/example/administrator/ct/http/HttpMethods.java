package com.example.administrator.ct.http;


import android.util.Log;

import com.example.administrator.ct.common.Constants;
import com.example.administrator.ct.http.entity.HttpResult;
import com.example.administrator.ct.http.service.CategroyService;
import com.example.administrator.ct.http.service.GoodsService;
import com.example.administrator.ct.http.service.MemberService;
...
public class HttpMethods {
    ...
    protected static CategroyService categroyService;
    ...
    public HttpMethods(){
        ...
        if(sInstance == null){
            ...
            categroyService = retrofit.create(CategroyService.class);
        }
